  ...
  return (
    <>
      <div className='w-full max-w-sm relative bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700'>
        <Badge className='absolute bg-gray-700 mt-2 mx-2'>Badge</Badge>

        <div className='justify-center flex'>
          <Image
            className='p-8 rounded-t-lg rounded-sm'
            src={article.imgSrc}
            alt='Article Image'
            width='220'
            height='150'
        ...
        <div className='px-5 pb-3'>
          ...
          <div className='flex items-center justify-between'>
            ...
            <Button
              label='Add to cart'
              iconClassName="text-white hover:text-black"
              icon={FaCartShopping}
              className='rounded-full flex gap-2 items-center hover:text-black hover:bg-white font-semibold   bg-black  px-3 py-2 outline-none hover:scale-[.98] outline-[1px] hover:outline-black'
            />
          </div>
          ...
          <div className='flex items-center mt-2.5 '>
            ...
            <span className='bg-blue-100 text-red-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-blue-800 ms-3'>
              5.0
            </span>
          </div>
        </div>
